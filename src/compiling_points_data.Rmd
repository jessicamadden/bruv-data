...
point_data_perc_jul_1 <- point_data %>% 
  ...
  select(op_code, site_full, type, geog, date, bruv, five_min, subclass, family, common, number) %>% 
  complete(nesting(op_code, site_full, type, geog, date, bruv), five_min, nesting(subclass, family, common), fill=list(number=0)) %>% 
  group_by(op_code, site_full, type, geog, date, bruv, five_min, subclass, family, common) %>% 
...
point_data_complete <- point_data %>% 
  select(op_code, site_full, type, geog, date, bruv, subclass, family, common, number) %>% 
...
point_tenmin_complete <- point_data %>% 
  select(op_code, site_full, type, geog, date, bruv, ten_min, subclass, family, common, number) %>% 
  complete(nesting(op_code, site_full, type, geog, date, bruv), ten_min, nesting(subclass, family, common), fill=list(number=0)) %>% 
  group_by(op_code, site_full, type, geog, date, bruv, ten_min, subclass, family, common) %>% 
  summarize(number = sum(number)) %>% 
